...
class ExoDownloadService : DownloadService(
    NOTIFICATION_ID, 1000L, CHANNEL_ID, R.string.download, 0
) {
    @Inject
    ...
    override fun getForegroundNotification(
    ...
    ): Notification = Notification.Builder.recoverBuilder(
        ...
        Notification.Action.Builder(
            ...
            PendingIntent.getService(
                this, 0, Intent(this, ExoDownloadService::class.java).setAction(
        ...
        override fun onDownloadChanged(
            ...
            if (download.state == Download.STATE_FAILED) {
                val notification = notificationHelper.buildDownloadFailedNotification(
                    context, R.drawable.error, null, Util.fromUtf8Bytes(download.request.data)
                )
